/**
 * Script: Import SGV Mixed Cuisine restaurants
...
const CSV_PATH = '/Users/bobbyciccaglione/Downloads/sgv-mixed.csv'
...
async function main() {
  console.log('🍜 Starting SGV Mixed Cuisine Import...\n')
  ...
  const listTitle = 'SGV Eater LA Picks'
