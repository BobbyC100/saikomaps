/**
 * Script: Import Venice restaurants
...
const CSV_PATH = '/Users/bobbyciccaglione/Downloads/venice.csv'
...
async function main() {
  console.log('🏖️  Starting Venice Import...\n')
  ...
  const listTitle = 'Venice Dining Guide'
