/**
 * Script: Import Santa Monica restaurants
...
const CSV_PATH = '/Users/bobbyciccaglione/Downloads/santa-monica.csv'
...
async function main() {
  console.log('🌊 Starting Santa Monica Import...\n')
  ...
  const listTitle = 'Santa Monica Dining Guide'
