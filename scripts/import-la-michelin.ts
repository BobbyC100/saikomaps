/**
 * Script: Import LA Michelin & Essential Restaurants
 * Premium dining destinations across LA
 */
...
const CSV_PATH = '/Users/bobbyciccaglione/Downloads/la-michelin-essential.csv'
...
async function main() {
  console.log('⭐ Starting LA Michelin & Essential Import...\n')
  ...
  const listTitle = 'LA Michelin & Essential Restaurants'
