/**
 * Script: Add SGV Bakeries to existing Eater LA map
...
const CSV_PATH = '/Users/bobbyciccaglione/Downloads/sgv-bakeries.csv'
const MAP_SLUG = 'sgv-eater-la-picks-1770426120560' // Use existing map
...
async function main() {
  console.log('🥐 Adding SGV Bakeries to Eater LA Picks map...\n')
