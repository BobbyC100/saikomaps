/**
 * Script: Import South Bay Beach Cities
...
const CSV_PATH = '/Users/bobbyciccaglione/Downloads/south-bay-beach-cities.csv'
...
async function main() {
  console.log('🏖️  Starting South Bay Beach Cities Import...\n')
  ...
  const listTitle = 'South Bay Beach Cities'
