    ...
    for (const e of energyScores) {
      await targetClient.energy_scores.upsert({
        ...
        create: {
          ...
          energyConfidence: e.energyConfidence,
          version: e.version,
          computedAt: e.computedAt,
          popularityComponent: e.popularityComponent,
          languageComponent: e.languageComponent,
          flagsComponent: e.flagsComponent,
          sensoryComponent: e.sensoryComponent,
          hasPopularity: e.hasPopularity,
          hasLanguage: e.hasLanguage,
          hasFlags: e.hasFlags,
          hasSensory: e.hasSensory,
        },
        update: {
          energyScore: e.energyScore,
          energyConfidence: e.energyConfidence,
    ...
    for (const t of tagScores) {
      await targetClient.place_tag_scores.upsert({
        ...
        create: {
          id: t.id,
          entityId: t.entityId,
          cozyScore: t.cozyScore,
          dateNightScore: t.dateNightScore,
          lateNightScore: t.lateNightScore,
          afterWorkScore: t.afterWorkScore,
          sceneScore: t.sceneScore,
          confidence: t.confidence,
          version: t.version,
          dependsOnEnergyVersion: t.dependsOnEnergyVersion,
