/**
 * Script: Import San Fernando Valley restaurants
...
const CSV_PATH = '/Users/bobbyciccaglione/Downloads/san-fernando-valley.csv'
...
async function main() {
  console.log('🎬 Starting San Fernando Valley Import...\n')
  ...
  const listTitle = 'San Fernando Valley Dining Guide'
