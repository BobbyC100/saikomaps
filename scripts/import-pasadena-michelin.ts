/**
 * Script: Import Pasadena Michelin restaurants
...
const CSV_PATH = '/Users/bobbyciccaglione/Downloads/pasadena-michelin.csv'
...
async function main() {
  console.log('⭐ Starting Pasadena Michelin Import...\n')
  ...
  const listTitle = 'Pasadena Michelin Guide'
