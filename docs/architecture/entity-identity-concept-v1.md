...
# SAIKO FIELDS — entity identity Concept Document
...
> **Scope:** entity identity only. Does not cover user identity, operator identity, or auth.
...
This document defines entity identity as a system concept.

All feature docs, pipeline specs, and admin tools must reference this document rather than redefine identity independently.

---

## 2. What Is a entity identity

A entity identity is the canonical representation of a real-world place within Saiko Fields.
...
*Saiko Fields · entity identity Concept Doc · Draft March 2026 · Not Canon*
