...
These fields currently exist on `entities` but belong in `place_coverage_status`:
...
- `docs/ENTITIES_CONTRACT_RECONCILIATION.md` — Full field-level audit and decision log
- `docs/DEFERRED_MIGRATION_GATES.md` — Gate conditions for the two deferred migrations
- `prisma/migrations/20260306200000_slim_entities_fields_v2/migration.sql` — Deferred migration 1
- `prisma/migrations/20260306300000_drop_legacy_tables_fields_v2/migration.sql` — Deferred migration 2
