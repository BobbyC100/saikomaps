...
import { FILTERS, type MapCardData, type EntityCardData, type ExploreMode, type ViewMode } from './types'
...
export default function ExploreClient() {
  ...
  const [places, setPlaces] = useState<EntityCardData[]>([])
              ...
              <div>
                ...
                <div className="map-list">
                  {places.slice(0, 6).map((place) => (
                    <EntityListItem key={place.id} place={place} />
                  ))}
                </div>
              </div>
            )}
