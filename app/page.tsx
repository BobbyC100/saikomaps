...
export default function HomePage() {
  const browse = [
    ...
    },
    {
      ...
      card: {
        ...
        count: 22,
        imageUrl:
          'https://images.unsplash.com/photo-1504718855392-c0f33b372e72?w=600&h=450&fit=crop',
  ...
  const neighborhoods = [
    {
      ...
      count: 31,
      imageUrl:
        'https://images.unsplash.com/photo-1559329007-40df8a9345d8?w=600&h=450&fit=crop',
    ...
    },
    {
      ...
      count: 67,
      imageUrl:
        'https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=600&h=450&fit=crop',
  ...
  const categories = [
    {
      ...
      count: 19,
      imageUrl:
        'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=600&h=375&fit=crop',
    ...
    },
    {
      ...
      count: 38,
      imageUrl:
        'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600&h=375&fit=crop',
    ...
    },
    {
      ...
      count: 8,
      imageUrl:
        'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=600&h=375&fit=crop',
    ...
    },
    {
      ...
      count: 24,
      imageUrl:
        'https://images.unsplash.com/photo-1504718855392-c0f33b372e72?w=600&h=375&fit=crop',
  ...
  const experiences = [
    ...
    },
    {
      ...
      href: '/explore?experience=solo-dinner',
    },
    {
      name: 'Group Night',
      count: 31,
      ...
      href: '/explore?experience=group-night',
    },
    {
      name: 'Late Night',
      count: 22,
    ...
    },
    {
      ...
      href: '/explore?experience=celebration',
    },
  ]
