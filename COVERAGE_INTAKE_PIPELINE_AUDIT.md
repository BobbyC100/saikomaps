...
- **places:** id, slug, googlePlaceId, name, address, lat/lng, phone, website, instagram, hours, description, googlePhotos, googleTypes, priceLevel, neighborhood, category, status, editorialSources, cuisineType, tagline, chefRecs, restaurantGroupId, intentProfile, reservationUrl, placeType, categoryId, parentId, etc. Relations: map_places, person_places, restaurant_groups, category_rel, parent/children, viewer_bookmarks.
